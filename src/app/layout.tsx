...
export const metadata: Metadata = {
  ...
  description: "Đoàn Đỗ Thành Danh (Zah) - Passionate Solana Buidler, Blockchain Developer, and Web3 Enthusiast. Building decentralized applications on Solana.",
  ...
  openGraph: {
    title: "Zah | Solana Developer Portfolio",
    description: "Passionate Solana Buidler, Blockchain Developer, and Web3 Enthusiast",
    type: "website",
  },
  twitter: {
